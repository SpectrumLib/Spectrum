...
namespace Spectrum.Graphics
{
	...
	public struct TextureRegion : IEquatable<TextureRegion>
	{
		...
		internal readonly Vk.Offset3D VkOffset => new Vk.Offset3D((int)X, (int)Y, (int)Z);
		internal readonly Vk.Extent3D VkExtent => new Vk.Extent3D(Width, Height, Depth);
		#endregion // Fields
		...
		public readonly bool ValidFor(TextureType type)
		{
			return (Width >= 1) && (
